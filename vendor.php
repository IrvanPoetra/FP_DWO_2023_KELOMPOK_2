<?php include 'koneksi.php';
    ...
    $sql = "SELECT
    concat('name:',dv.activeflag) AS name, 
    concat('y:',COUNT(dv.vendor_id)) AS y , 
    concat('drilldown:',dv.vendor_name) as drilldown 
    from 
    vendor dv group by name";
    ...
    $sql = "SELECT dv.activeflag AS rating, COUNT(dv.vendor_id) AS vendor
    from vendor dv
    group by rating";
    ...
    $sql = "SELECT dv.activeflag AS rating, 
    dv.vendor_name as Name, 
    COUNT(dv.vendor_id) as QTY
    from vendor dv
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT COUNT(vendor_id) as vd from vendor";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT COUNT(vendor_id) as emp from vendor
                                                where activeflag='1'";
                                                $query = mysqli_query($conn, $sql);
                                                if (mysqli_num_rows($query) > 0){
                                                    while($row2=mysqli_fetch_array($query)){
