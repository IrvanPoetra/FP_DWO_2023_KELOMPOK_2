                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT SUM(SubTotal) as LineTotal from fakta_pendapatan";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT SUM(fs.SubTotal) as LineTotal 
                                                from fakta_pendapatan fs
                                                join time dt on fs.TimeID = dt.TimeID
                                                where tahun='2001'";
                                                $query = mysqli_query($conn, $sql);
                                                if (mysqli_num_rows($query) > 0){
                                                    while($row2=mysqli_fetch_array($query)){
...
<script src="vendor/jquery/jquery.min.js"></script>
    ...
    xAxis: {
        categories : [
            <?php 
                $sql = "SELECT ROUND(SUM(fs.SubTotal)) as LineTotal, dt.tahun as tahun from fakta_pendapatan fs 
                join time dt on fs.TimeID = dt.TimeID 
                group by tahun";
                $query = mysqli_query($conn, $sql);
                if (mysqli_num_rows($query) > 0){
